...
[Vela](https://vela.simplyblock.io) is a Postgres development platform. It builds on top of the original foundation of
Supabase and extends it back into a fully self-hostable, enterprise-grade database platform with the following
features:

- [x] Hosted Postgres Database. [Docs](https://supabase.com/docs/guides/database)
- [x] Authentication and Authorization.
- [x] Full Roll-based Access Control (RBAC).
...
![Vela-Studio Dashboard](https://raw.githubusercontent.com/simplyblock/vela-studio/master/apps/www/public/images/github/supabase-dashboard.png)
...
- [Community Forum](https://github.com/simplyblock/vela-studio/discussions). Best for: help with building, discussion about database best practices.
- [GitHub Issues](https://github.com/simplyblock/vela-studio/issues). Best for: bugs and errors you encounter using Vela.

## How it works

Vela is a combination of open source tools. We’re building the features of Firebase using enterprise-grade, open-source products. If the tools and communities exist, with an MIT, Apache 2, or equivalent open license, we will use and support that tool. If the tool doesn't exist, we build and open source it ourselves. Vela is not a 1-to-1 mapping of Firebase. Our aim is to give developers a Firebase-like developer experience using open source tools.

**Architecture**

Vela is a self-hostable platform.
