...
const WHITELIST_ERRORS = [
  ...
  'Project creation in the Veladashboard is disabled for this Vercel-managed organization.',
  'Your account, which is handled by the Fly Velaextension, cannot access this endpoint.',
