...
You may opt to manage your queues via any Supabase client libraries or PostgREST endpoints by enabling this in the [queues settings](/project/${project?.id}/integrations/queues/settings).`}
                      />
                      <Button
                        type="default"
                        className="w-min"
