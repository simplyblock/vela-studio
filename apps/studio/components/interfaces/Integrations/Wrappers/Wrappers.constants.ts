...
export const WRAPPERS: WrapperMeta[] = [
  {
    ...
    label: 'Stripe',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/stripe',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Firebase',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/firebase',
    server: {
      options: [
        {
          name: 'project_id',
  ...
  },
  {
    ...
    extensionName: 'S3Fdw',
    label: 'S3',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/s3',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'ClickHouse',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/clickhouse',
    server: {
      options: [
        {
          name: 'conn_string_id',
  ...
  },
  {
    ...
    label: 'BigQuery',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/bigquery',
    server: {
      options: [
        {
          name: 'sa_key_id',
  ...
  },
  {
    ...
    label: 'Airtable',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/airtable',
    server: {
      options: [
        {
          name: 'api_key_id',
  ...
  },
  {
    ...
    label: 'Auth0',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/auth0',
  ...
  },
  {
    ...
    label: 'Cognito',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/cognito',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/mssql',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Redis',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/redis',
    minimumExtensionVersion: '0.3.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Paddle',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/paddle',
  ...
  },
  {
    ...
    label: 'Snowflake',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/snowflake',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Iceberg',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/iceberg',
  ...
  },
  {
    ...
    label: 'Cal.com',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/cal',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Calendly',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/calendly',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
  ...
  },
  {
    ...
    label: 'Clerk',
    docsUrl: 'https://vela.run/docs/guides/database/extensions/wrappers/clerk',
    minimumExtensionVersion: '0.4.0',
    server: {
      options: [
        {
