export const CLIENT_LIBRARIES = [
  {
    ...
    docsUrl: 'https://vela.run/docs/reference/javascript/installing',
    gitUrl: 'https://github.com/simplyblock/vela-studio-js',
  },
  {
    language: 'Flutter',
    officialSupport: true,
    releaseState: undefined,
    docsUrl: 'https://vela.run/docs/reference/dart/installing',
    gitUrl: 'https://github.com/simplyblock/vela-studio-flutter',
  },
  {
    language: 'Python',
    officialSupport: true,
    releaseState: 'Alpha',
    docsUrl: 'https://vela.run/docs/reference/python/initializing',
    gitUrl: 'https://github.com/simplyblock/vela-studio-py',
  },
  {
    language: 'C#',
    officialSupport: false,
    releaseState: undefined,
    docsUrl: 'https://vela.run/docs/reference/csharp/installing',
  ...
  },
  {
    ...
    officialSupport: true,
    releaseState: undefined,
    docsUrl: 'https://vela.run/docs/reference/swift/initializing',
    gitUrl: 'https://github.com/simplyblock/vela-studio-swift',
  },
  {
    language: 'Kotlin',
    officialSupport: false,
    releaseState: undefined,
    docsUrl: 'https://vela.run/docs/reference/kotlin/installing',
...
export const EXAMPLE_PROJECTS = [
  {
    ...
    description: 'A Trello clone using Vela as the storage system.',
  ...
  },
  {
    ...
    description: 'Next.js Slack clone app using Vela realtime subscriptions',
    url: 'https://github.com/simplyblock/vela-studio/tree/master/examples/slack-clone/nextjs-slack-clone',
    type: 'app',
  },
  {
    framework: 'nextjs',
  ...
  },
  {
    ...
    description: 'NestJS example using Vela Auth',
  ...
  },
  {
    ...
    url: 'https://github.com/simplyblock/vela-studio/tree/master/examples/todo-list/nextjs-todo-list',
    type: 'app',
  },
  {
    framework: 'Svelte',
    ...
    url: 'https://github.com/simplyblock/vela-studio/tree/master/examples/todo-list/sveltejs-todo-list',
    type: 'app',
  },
  {
    framework: 'Flutter',
  ...
  },
  {
    ...
    url: 'https://github.com/simplyblock/vela-studio-swift/tree/main/Examples/UserManagement',
    type: 'mobile',
  },
  {
    framework: 'Swift',
    ...
    url: 'https://github.com/simplyblock/vela-studio-swift/tree/main/Examples/SlackClone',
    type: 'mobile',
  },
  {
    framework: 'Flutter',
    ...
    url: 'https://github.com/simplyblock/vela-studio/tree/master/examples/auth/flutter-mfa',
  },
  {
    framework: 'NuxtJS',
