              ...
              <div>
                ...
                <div className="grid grid-cols-2 items-center">
                  <p className="text-sm text-lighter max-w-lg">
                    Velaemploys auto-scaling storage and allows for manual disk size
                  ...
                  <div className="col-span-4 grid grid-cols-2 gap-x-12 gap-y-4 items-start">
                    ...
                    <div className="col-span-2 mt-4">
                      <Button asChild type="default" iconRight={<ExternalLink size={14} />}>
                        <Link
                          href={`/org/${orgRef}/project/${projectRef}/branch/${branchRef}/reports/database#database-size-report`}
                        >
