...
group by
  ...
  {
    label: 'Metadata IP',
    description: 'List all IP addresses that used the VelaAPI',
    mode: 'custom',
    searchString: `select
...
`,
  ...
  },
  {
    ...
    description: 'List all ISO 3166-1 alpha-2 country codes that used the VelaAPI',
    mode: 'custom',
    searchString: `select
  cf.country,
  count(*) as count
...
`,
  ...
  },
  {
    ...
    mode: 'custom',
    description: 'List all VelaAPI requests that are slow',
    searchString: `select
  cast(timestamp as datetime) as timestamp,
  event_message,
  r.origin_time
...
`,
  ...
  },
  {
    ...
    description: 'List all VelaAPI requests that responded witha 5XX status code',
    mode: 'custom',
    searchString: `select
  cast(timestamp as datetime) as timestamp,
  event_message,
...
`,
  ...
  {
    label: 'Top Paths',
    description: 'List the most requested VelaAPI paths',
    mode: 'custom',
    searchString: `select
  r.path as path,
  r.search as params,
...
export const LOG_ROUTES_WITH_REPLICA_SUPPORT = [
  '/org/[slug]/project/[ref]/branch/[branch]/logs/edge-logs',
  '/org/[slug]/project/[ref]/branch/[branch]/logs/pooler-logs',
  '/org/[slug]/project/[ref]/branch/[branch]/logs/postgres-logs',
  '/org/[slug]/project/[ref]/branch/[branch]/logs/postgrest-logs',
]
