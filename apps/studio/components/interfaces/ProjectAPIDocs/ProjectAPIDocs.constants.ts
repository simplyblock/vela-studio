...
- Install the Supabase [CLI](https://vela.run/docs/guides/cli).
...
You can generate types from your database either through the [Supabase CLI](https://vela.run/docs/guides/database/api/generating-types), or by downloading the types file via the button on the right and importing it in your application within \`src/index.ts\`.
`,
    js: undefined,
    bash: undefined,
  },
