    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader padding="small" className="border-b">
          <DialogTitle>Data Privacy and VelaAI</DialogTitle>
        </DialogHeader>
        <DialogSection
          padding="small"
        ...
        >
          <p>
            VelaAI utilizes Amazon Bedrock ("Bedrock"), a service designed with a strong focus
          ...
          <p>
            ...
            With your permission, Velamay share customer-generated prompts, database schema,
          ...
          <p>
            ...
            Velahas a Business Associate Agreement in place covering this use.
          </p>
