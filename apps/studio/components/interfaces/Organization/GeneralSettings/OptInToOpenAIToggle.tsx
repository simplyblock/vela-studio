    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader padding="small" className="border-b">
          <DialogTitle>Data Privacy and Vela AI</DialogTitle>
        </DialogHeader>
        <DialogSection
          padding="small"
        ...
        >
          <p>
            Vela AI utilizes Amazon Bedrock ("Bedrock"), a service designed with a strong focus
          ...
          <p>
            ...
            With your permission, Vela may share customer-generated prompts, database schema,
          ...
          <p>
            ...
            Vela has a Business Associate Agreement in place covering this use.
          </p>

          <p>
            For more detailed information about how we collect and use your data, see our{' '}
            <InlineLink href="https://vela.run/privacy">Privacy Policy</InlineLink>. You can
