...
export const EditorTabs = () => {
  ...
  const handleCloseAll = () => {
    if (editor) {
      ...
      router.push(`/org/${slug}/project/${ref}/branch/${branchRef}/${editor === 'table' ? 'editor' : 'sql'}`)
    }
  }
  ...
  const handleCloseOthers = (tabId: string) => {
    if (editor) {
      ...
      if (id !== entityId) {
        router.push(`/org/${slug}/project/${ref}/branch/${branchRef}/${editor === 'table' ? 'editor' : 'sql'}/${entityId}`)
      }
    }
  }
          ...
          <AnimatePresence initial={false}>
            {!hasNewTab && (
              <motion.button
                ...
                onClick={() =>
                  router.push(
                    `/org/${slug}/project/${router.query.ref}/branch/${branchRef}/${editor === 'table' ? 'editor' : 'sql'}/new?skip=true`
                  )
                }
