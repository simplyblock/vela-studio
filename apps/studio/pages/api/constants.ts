...
export const VELA_PLATFORM_EXT_KEYCLOAK_URL = process.env.VELA_PLATFORM_EXT_KEYCLOAK_URL
export const VELA_PLATFORM_KEYCLOAK_URL = process.env.NEXT_PUBLIC_VELA_PLATFORM_KEYCLOAK_URL
export const VELA_PLATFORM_KEYCLOAK_REALM = process.env.NEXT_PUBLIC_VELA_PLATFORM_KEYCLOAK_REALM
export const VELA_PLATFORM_KEYCLOAK_CLIENT_ID = process.env.NEXT_PUBLIC_VELA_PLATFORM_KEYCLOAK_CLIENT_ID
export const VELA_PLATFORM_KEYCLOAK_CLIENT_SECRET = process.env.NEXT_PUBLIC_VELA_PLATFORM_KEYCLOAK_CLIENT_SECRET
